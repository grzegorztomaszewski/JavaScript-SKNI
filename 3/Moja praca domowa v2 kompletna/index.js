...
//[0]
    btn.addEventListener("click", () => {
        if(selectedValue == "ul" && ulTagAll[0].style.backgroundColor == defaultStatus){
...
//[0]
    btn.addEventListener("click", () => {
        if(selectedValue == "h1" && h1TagAll[0].style.backgroundColor == defaultStatus){
...
//[1]
        if(selectedValue == "h1" && h1TagAll[1].style.backgroundColor == defaultStatus){
...
//[2]
        if(selectedValue == "h1" && h1TagAll[2].style.backgroundColor == defaultStatus){
...
//[3]
        if(selectedValue == "h1" && h1TagAll[3].style.backgroundColor == defaultStatus){
...
//[0]
    btn.addEventListener("click", () => {
        if(selectedValue == "ol" && olTagAll[0].style.backgroundColor == defaultStatus){
...
//[1]
        if(selectedValue == "ol" && olTagAll[1].style.backgroundColor == defaultStatus){
...
//[2]
        if(selectedValue == "ol" && olTagAll[2].style.backgroundColor == defaultStatus){
...
//[0]
    btn.addEventListener("click", () => {
        if(selectedValue == "p" && pTagAll[0].style.backgroundColor == defaultStatus){
...
//[1]
        if(selectedValue == "p" && pTagAll[1].style.backgroundColor == defaultStatus){
...
//[2]
        if(selectedValue == "p" && pTagAll[2].style.backgroundColor == defaultStatus){
